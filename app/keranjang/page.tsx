...
// Pastikan semua icon yang dipakai diimport
         ...
         <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-500">
                        {/* Link ke halaman internal (butuh file page-nya agar jalan) */}
                        ...
                        <li><Link href="/faq" className="hover:text-blue-600">FAQ</Link></li> {/* FAQ Ditambahkan */}
                        
                        {/* Link WhatsApp menggunakan tag <a> biasa */}
                        <li>
                            <a 
